...
hitable *random_scene() {
	int n = 5000;
	hitable **list = new hitable *[n + 1];
	texture *checker = new checker_texture(new constant_texture(vec3(0.2, 0.1, 0.3)), new constant_texture(vec3(0.9, 0.9, 0.9)));
...
int main()
{
	...
	ofstream outfile("chapter19_cornellSmoke.ppm", ios_base::out);
	// Output to .ppm file
	outfile << "P3\n" << nx << " " << ny << "\n255\n";
